...
void HiggsDecayType::evaluate () {
  ...
  // cout << "Inside HiggsDecayType evaluate, mcparticle collection is " << this->blocks->mcParticleCollection << endl;

  //cout << "Size of mc particles = " << this->blocks->mcParticleCollection->size() << endl;
